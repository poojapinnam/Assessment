...
import com.bank.StepsDefinitions.BrowserConfig;
import com.dbs.utilities.Utils;

import org.assertj.core.api.SoftAssertions;

import junit.framework.Assert;

public class DBSCreditCardsPage{
	...
	public void navigateToCreditCardsPage() {
		utils.Webdriver_waitToClick(webCardsLink);
		webCardsLink.click();
		BrowserConfig.parentTest.createNode("Clicked on Cards");
		utils.Webdriver_waitToClick(webCreditCards);
	...
	public void selectCardsAndClickOnCompare(String card1,String card2) {
		...
		utils.scrollTo(firstCard1);
		utils.waitForElement(firstCard);
		utils.clickUsingJS(firstCard);
		...
		utils.waitForElement(secondCard);
		utils.clickUsingJS(secondCard);
